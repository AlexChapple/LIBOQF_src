...
program main
    ...
    open(1, file="results_trapping_test/spin_up.txt", status="replace")
    open(2, file="results_trapping_test/spin_down.txt", status="replace")
    open(3, file="results_trapping_test/photon_counting.txt", status="replace")
    open(4, file="results_trapping_test/emission_tracking.txt", status="replace")
