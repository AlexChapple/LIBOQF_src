...
program main
    ...
    integer (kind=8), parameter :: N = 50d0 
    integer (kind=8), parameter :: end_time = 100d0 
    integer (kind=8), parameter :: time_steps = 125000d0 
    integer (kind=8), parameter :: num_of_simulations = 3892d0
    ...
    open(1, file="spin_up_large_N50.txt", status="replace")
    open(2, file="spin_down_large_N50.txt", status="replace")
    open(3, file="photon_counting_large_N50.txt", status="replace")
    open(4, file="waiting_time_large_N50.txt", status="replace")
    open(5, file="emission_tracking_N50.txt", status="replace")
