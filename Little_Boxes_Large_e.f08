...
program main
    ...
    integer (kind=8), parameter :: time_steps = 500000d0 
    integer (kind=8), parameter :: num_of_simulations = 270d0
    ...
    real (kind=8), parameter :: dt = 0.0002d0 
    integer (kind=8), parameter :: period = 10d0 
    ...
    integer (kind=8), parameter :: tracking_bin_width = 30000
    ...
    open(1, file="spin_up_large_N100_S.txt", status="replace")
    open(2, file="spin_down_large_N100_S.txt", status="replace")
    open(3, file="photon_counting_large_N100_S.txt", status="replace")
    open(4, file="waiting_time_large_N100_S.txt", status="replace")
    open(5, file="emission_tracking_N100_S.txt", status="replace")
