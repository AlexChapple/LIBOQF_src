...
program main
    ...
    integer (kind=8), parameter :: time_steps = 625000d0 
    ...
    real (kind=8), parameter :: dt = 0.00016d0 
    ...
    open(1, file="spin_up_large_N250.txt", status="replace")
    open(2, file="spin_down_large_N250.txt", status="replace")
    open(3, file="photon_counting_large_N250.txt", status="replace")
    open(4, file="waiting_time_large_N250.txt", status="replace")
    open(5, file="emission_tracking_N250.txt", status="replace")
